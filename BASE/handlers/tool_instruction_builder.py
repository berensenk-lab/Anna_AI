...
# BASE/handlers/tool_instruction_builder.py (UPDATE existing method)
    ...
    def build_tool_list_section(self) -> str:
        ...
        for tool_name in sorted(enabled_tools):
            ...
            description = metadata.get('tool_description') or metadata.get('description', 'No description')
    ...
    def _build_complete_tool_documentation(
        ...
        description = metadata.get('tool_description') or metadata.get('description', 'No description available')
